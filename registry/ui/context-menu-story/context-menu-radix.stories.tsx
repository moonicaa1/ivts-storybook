  ...
  render: (args) => (
    <ContextMenu {...args}>
      ...
      <ContextMenuContent className="w-32">
        ...
        <ContextMenuItem>
          Reload
          <ContextMenuShortcut>?쁒</ContextMenuShortcut>
        </ContextMenuItem>
      </ContextMenuContent>
    </ContextMenu>
  ),
  ...
  render: (args) => (
    <ContextMenu {...args}>
      ...
      <ContextMenuContent className="w-32">
        <ContextMenuItem>
          New Tab
          <ContextMenuShortcut>?쁍</ContextMenuShortcut>
        </ContextMenuItem>
        <ContextMenuSub>
          ...
          <ContextMenuSubContent>
            <ContextMenuItem>
              Save Page As...
              <ContextMenuShortcut>?㎮뙓S</ContextMenuShortcut>
            </ContextMenuItem>
    ...
    <ContextMenu {...args}>
      ...
      <ContextMenuContent className="w-64">
        <ContextMenuCheckboxItem checked>
          Show Comments
          <ContextMenuShortcut>?섃눉C</ContextMenuShortcut>
        </ContextMenuCheckboxItem>
